...
public class AdminHouseController {
	...
	@GetMapping
	public String index(Model model, @PageableDefault(page = 0, size = 10, sort = "id", direction = Direction.ASC) Pageable pageable, @RequestParam(name = "keyword", required = false) String keyword) {		// findAll()メソッドにPageableオブジェクトを渡す		//Page<House> housePage = houseRepository.findAll(pageable);
